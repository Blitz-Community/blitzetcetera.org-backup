;*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
; 											SMS LIB 
; 								Par Bobysait => Bobysait@free.fr
; 				Pour tous renseignements consultez moi sur http://www.BlitzFr.com
;
;
;						Faites vous plaisir, et utilisez le à volonté !
;
;*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
...
;=========================================================
; 	=========== Ajout d'un mesh Recepteur ============	; à finir !!!
;=========================================================
...
; initialise variables for the hadow system ( SMS Library )
	SMS_Init(World)
		LightR%			=	255
		LightG%			=	120
		LightB%			=	20
...
Repeat
	...
	;====================================/!>
		...
		SMS_Update			(light,camera,methode,100) ; maj ombres
	RenderWorld
		...
		; replace the mouse on the screen !
