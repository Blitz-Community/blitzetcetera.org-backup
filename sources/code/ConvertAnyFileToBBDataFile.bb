...
file$ = "ConvertAnyFileToBBDataFile.bb" ;<- specify a file to convert to .bb data
datafile$ = "Data.bb" ;<- specify the .bb file to create
...
;fileout = WriteFile("test.bb") ;<- specify the file to recreate
;While byte>=0
