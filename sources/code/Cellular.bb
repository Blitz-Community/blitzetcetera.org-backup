...
; input
;If KeyDown(this\keymap[4])
;; accellerate in the direction the player is facing (use Y axis because cones point in that direction)
;TFormVector(0,0,PLAYER_ACCEL,this\entity,PLAYER_GLOBAL_SPACE)
;this\xv = this\xv + TFormedX()
;this\yv = this\yv + TFormedY()
;this\zv = this\zv + TFormedZ()
;; measure current speed
;current_speed# = Sqr(this\xv*this\xv + this\yv*this\yv + this\zv*this\zv)
;If current_speed > PLAYER_MAX_SPEED
;; limit current speed to MAX_SPEED
;ratio_of_speed_to_keep#=PLAYER_MAX_SPEED/current_speed
;this\xv = this\xv * ratio_of_speed_to_keep
;this\yv = this\yv * ratio_of_speed_to_keep
;this\zv = this\zv * ratio_of_speed_to_keep
;EndIf
;EndIf
;
;If  KeyDown(this\keymap[3]) 
;this\xv = this\xv - TFormedX()
;this\yv = this\yv - TFormedY()
;this\zv = this\zv - TFormedZ()
;current_speed# = Sqr(this\xv*this\xv + this\yv*this\yv + this\zv*this\zv)
