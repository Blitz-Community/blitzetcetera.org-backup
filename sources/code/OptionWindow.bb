...
Global fntStandard = LoadFont("Arial",24, False, False, False)
Global fntSmallB = LoadFont("Arial",48, True, False, False)
Global gfxTest = LoadImage ("wcrate.jpg") ; change this to test own graphics
